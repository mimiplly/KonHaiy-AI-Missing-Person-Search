...
const Navbar = () => {
  ...
  const KonHaiyIcon = process.env.PUBLIC_URL + '/KonHaiyIcon.png';
  return (
    ...
    <div className="w-1/6 flex items-center ">
            <img src={KonHaiyIcon} alt="KonHaiy AI logo" width="30px"/>
        ...
        <div className="flex items-center">
            <ul id="list" className={`${menu ? '' : 'hidden'} p-2 border-r bg-white absolute rounded top-0 left-0 right-0 shadow mt-16 md:mt-16`}>
                ...
                <li className="flex flex-col cursor-pointer text-gray-600 text-sm leading-3 tracking-normal py-2 hover:text-indigo-700 focus:text-indigo-700 focus:outline-none flex justify-center">
                     <a href={process.env.REACT_APP_SURVEILLANCE_URL || "http://localhost:8501/"}>
...
<nav  role="navigation" aria-label="Main" tabIndex="0" className="hidden relative z-10 w-full lg:flex justify-between items-center p-8" style={{backgroundColor:'#f2faff'}}>
    <div className="w-1/6 flex items-center ">
        <a tabIndex="0" aria-label="KonHaiy AI logo" href="/">
        <img src={KonHaiyIcon} alt="KonHaiy AI logo" width="60px"/> 
        </a>
        <div className="titlename" style={{fontSize:'30px',fontWeight:700,letterSpacing:'1px',color:'#012970',fontFamily:'sans-serif'}}>
          KonHaiy AI
        </div>
        ...
        <div className="flex items-center justify-end">  
            <ul className="text-gray-800 lg:space-x-8 flex items-center leading-none">
                ...
                <li className="ml-4 hover:text-indigo-500 ">
                     <a className="focus:text-indigo-500 text-lg" href={process.env.REACT_APP_SURVEILLANCE_URL || "http://localhost:8501/"}>Surveillance Area</a>
                </li>
